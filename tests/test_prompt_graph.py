...
#
# A test that quotes one sentence proves that sentence exists in one file. It
# cannot see a second file saying the opposite, and every contradiction this
# suite has missed was exactly that: two files describing one behaviour. What
# follows pins the relations BETWEEN files — a field and its readers, a question
# number and whoever writes the answer, a shared rule and the Steps it governs.
# --------------------------------------------------------------------------- #
