...
Content MUST end with the reply marker of `core/finding-markers.md`, blank line before it as that atom
requires — the stable thing Step 3 reads back, independent of prose shape.
