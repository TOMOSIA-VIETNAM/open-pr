...
| no | no | — | continue Step 8/9 NORMALLY (nothing was open to handle) — FORBIDDEN: skipping merely because nothing is new, or the dev gets no confirmation for this update; land on the LGTM tier |
| yes | — | — | continue Step 8/9, but the general assessment covers ONLY what is new/changed this round, never restating a previous review |
