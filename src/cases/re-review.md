...
| no | no | yes | drop Step 8/9, post nothing further — nothing was fixed, so every postable line duplicates the review already standing, and a top-level "all clear" would mislead |
